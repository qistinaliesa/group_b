              ...
              <div class="checkout__totals">
                ...
                <table class="checkout-totals">
                    <tbody>
                        <tr>
                            <th>Subtotal</th>
                            <td class="text-right">RM{{ Cart::instance('cart')->subtotal() }}</td>
                        </tr>
                        <tr>
                            <th>Discount {{Session::get('coupon')['code']}}</th>
                            <td class="text-right"> RM{{ Session::get('discount')['discount'] }}</td>
                        </tr>
                        <tr>
                          <th>Subtotal After Discount</th>
                          <td class="text-right">RM{{ Session::get('discount')['subtotal'] }}</td>
                      </tr>
                      <tr>
                        <th>Shipping</th>
                    ...
                    <tr>
                      <th>VAT</th>
                      <td class="text-right">RM{{ Session::get('discount')['tax'] }}</td>
                  </tr>
                        <tr>
                            <th>Total</th>
                            <td>RM{{ Session::get('discount')['total'] }}</td>
                        </tr>
                      </tbody>
                @else
                <table class="checkout-totals">
                  <tbody>
                    ...
                    <tr>
                      <th>VAT</th>
                      <td class="text-right">RM{{Cart::instance('cart')->tax()}}</td>
                    </tr>
                    <tr>
                      <th>TOTAL</th>
                      <td class="text-right">RM{{Cart::instance('cart')->total()}}</td>
                    </tr>
                  </tbody>
                </table>
                @endif
